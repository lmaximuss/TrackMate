...
public class Canny_Edge_Detector< T extends RealType< T > & NativeType< T >>  extends LogDetector< T >  {



	public Canny_Edge_Detector(RandomAccessible<T> img, Interval interval, double[] calibration, double radius,
			double threshold, boolean doSubPixelLocalization, boolean doMedianFilter) {
